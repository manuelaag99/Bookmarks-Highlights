...
const ConfirmDelete = props => {
    const confirmDelete = (
        <div>
            ...
            <div className="flex flex-col bg-var-2 shadow-card md:w-6/10 w-8/10 md:h-48 h-3/10 fixed top-[30%] left-[10%] md:left-[20%]">
                <div className="md:h-3/10 h-2/10 w-full bg-var-1">

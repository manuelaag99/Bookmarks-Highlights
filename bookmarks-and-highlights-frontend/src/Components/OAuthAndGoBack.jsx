    ...
    return (
        <div className="flex flex-wrap w-full">
            <div className="my-4 w-full">
                <Button classnames=" text-var-5 bg-var-1 hover:bg-var-1-hovered " buttonText={props.googleOAuthText} isDefaultButton={false} isFacebookButton={false} isGoogleButton={true}/>
            </div>
            <div className="my-4 w-full">

    ...
    return (
            <div className="w-85 md:h-6/10 h-8/10 md:mt-32 mt-16 flex flex-wrap flex-row">
                ...
                <div className="md:w-2/3 w-3/5 md:h-7/10 h-3/10 pl-6 block md:hidden">
                    <FormForAddOrUpdate labelText="Title of the book/article:" placeholderText="i.e. Title (author, year)" inputType="text" />
                </div>
                <div className="h-7/10 w-full md:w-2/3 pl-3">
                    ...
                    <div className="flex flex-wrap flex-row justify-evenly">
                        <FormForAddOrUpdate labelText="date:" placeholderText="DD/MM/YYYY" classnames="w-2/3 " inputType="date" value="30/09/2020" />
                        <FormForAddOrUpdate labelText="page #:" placeholderText="e.g. 31, 105" classnames="w-1/3 " inputType="number" />
                    </div>
                    <FormForAddOrUpdate labelText="tags:" placeholderText="e.g. geography..." classnames="w-full mt-6 " />
                    <div className="mt-6">

                ...
                <div className="md:w-1/2 w-full flex flex-wrap md:h-screen h-[50vh] justify-center items-center">
                    <div className="md:w-1/2 w-7/10 flex flex-wrap h-1/4">
                        <Link className="w-full" to="/signin">
                            <Button buttonText="Sign in" classnames=" text-var-1 bg-var-4 hover:bg-var-4-hovered mt-0 " isDefaultButton={true} isFacebookButton={false} isGoogleButton={false} />
                        </Link>
                        <Breaker breakerText="or" isSignInPage={false} isSignInOrSignUpPage={true}/>
                        <Link className="w-full" to="/signup">
                            <Button buttonText="Sign up" classnames=" text-var-1 bg-var-4 hover:bg-var-4-hovered mt-0 " isDefaultButton={true} isFacebookButton={false} isGoogleButton={false} />
                        </Link>
                    </div>
                </div>
                <LogoForAuth/>
